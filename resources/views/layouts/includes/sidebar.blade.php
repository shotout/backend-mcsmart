    ...
    <div class="navbar-wrapper">
        <div class="navbar-brand header-logo">
            <a href="{{ url('dashboard') }}" class="b-brand">
                ...
                <span class="b-title" title="{{ 'Mcsmart App' }}">{{ 'Mcsmart App' }}</span>
            </a>
            ...
            <ul class="nav pcoded-inner-navbar">
                ...
                <li data-username="app" class="nav-item pcoded-hasmenu {{ $menu == 'app' ? 'pcoded-trigger active' : '' }}">
                    ...
                    <ul class="pcoded-submenu">
                        <!-- <li class="{{ isset($sub_menu) && $sub_menu == 'groupcategory' ? 'active' : '' }}"><a href="{{ url('group/list') }}" class="">{{ __('Group Facts Category') }}</a></li> -->
                        <li class="{{ isset($sub_menu) && $sub_menu == 'categories' ? 'active' : '' }}"><a href="{{ url('categories/list') }}" class="">{{ __('Facts Category') }}</a></li>
                        <li class="{{ isset($sub_menu) && $sub_menu == 'quotes' ? 'active' : '' }}"><a href="{{ url('quotes/list') }}" class="">{{ __('Facts Tracking') }}</a></li>
                    </ul>
                </li>
                <!-- <li data-username="setting" class="nav-item pcoded-hasmenu {{ $menu == 'setting' ? 'pcoded-trigger active' : '' }}">
                    <a href="javascript:" class="nav-link "><span class="pcoded-micon"><i class="feather icon-settings"></i></span><span class="pcoded-mtext">{{ __('Facts Pool') }} </span></a>
                    <ul class="pcoded-submenu">
